...
def load_model_and_tokenizer(
    base_model: str, pad_token_id: Optional[int] = None,
    ...
    if tokenizer.pad_token_id is None:
        if pad_token_id is not None:
            ...
            if tokenizer.unk_token_id is not None:
                ...
                raise ValueError("Cannot find pad_token_id. Please specify pad_token_id")
    else:
        if pad_token_id is not None:
            print(
...
if __name__ == "__main__":
    ...
    with open(args.parameter_file, "r") as f:
        params = json.load(f)
    if args.run_name not in params:
        raise KeyError(f"{args.run_name} not in parameters.json")
    assert_config(params[args.run_name])

    train(
        data_path=args.data_path,
        output_dir=args.output_dir,
        run_name=args.run_name,
        params=params[args.run_name],
